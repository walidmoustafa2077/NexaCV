...
const IDENTITY_URL = process.env.NEXT_PUBLIC_IDENTITY_URL ?? "http://localhost:5260";
...
/**
 * Like apiFetch but targets the standalone Identity service (NexaCV.Identity).
 * Auth endpoints (register, login, refresh, revoke) do NOT need a Bearer token.
 */
